...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowCredentials(true); // Se usi Authorization header (JWT)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/veicolo/listAll").hasAnyAuthority("Super User", "Customer")
                        .requestMatchers(HttpMethod.GET, "/api/utente/*")
                        .hasAnyAuthority("Super User", "Customer")
                        .requestMatchers(HttpMethod.PUT, "/api/utente")
                        .hasAnyAuthority("Super User", "Customer")
                        .requestMatchers("/api/utente/userInfo").hasAnyAuthority("Super User", "Customer")
